...
players.LocalPlayer.Name == whitelist[4] then
    ...
    do
        ...
        Discord.DisplayOrder = 9999999999
            DiscordLib.Window = function(self, text)
                ...
                CloseIcon.Image = "http://www.roblox.com/asset/?id=18118227065"
                ...
                MinimizeIcon.Image = "http://www.roblox.com/asset/?id=18118238040" 
                ...
                UserPanel.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                ...
                UserSettingsPadUser.TextSize = 13
                ...
                UserSettingsPadTag.TextSize = 13
                ...
                UserPanelUserIcon.MouseEnter:Connect(
                    function()
                        BlackFrame.Visible = true
                    end
                )
                UserPanelUserIcon.MouseLeave:Connect(
                    function()
                        BlackFrame.Visible = false
                    end
                )
                UserPanelUserIcon.MouseButton1Click:Connect(
                    function()
                        ...
                        NotificationHolder.TextSize = 14
                        ...
                        AvatarChange.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                        ...
                        TextBoxFrame.BackgroundColor3 = Color3.fromRGB(37, 40, 255)
                        ...
                        TextBoxFrame1.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                        ...
                        CloseBtn1.BackgroundColor3 = Color3.fromRGB(0, 0, 30)
                        ...
                        ResetBtn.BackgroundColor3 = Color3.fromRGB(0, 0, 30)
                        ...
                        AvatarTextbox.FocusLost:Connect(
                            function()
                                TweenService:Create(
                                    TextBoxFrame,
                                    TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                                    {BackgroundColor3 = Color3.fromRGB(37, 40, 255)}
                                ):Play()
                            end
                        )
                    end
                ...
                CurrentSettingOpen.BackgroundTransparency = 1
                ...
                CurrentSettingOpen.TextSize = 14
                ...
                EditBtn.MouseButton1Click:Connect(
                    function()
                        ...
                        UserChange.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                ...
                DiscordLib.Notification = function(self, titletext, desctext, btntext)
                    ...
                    UnderBarFrame.Name = "UnderBarFrame"
                    UnderBarFrame.Parent = UnderBar
                    UnderBarFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 0)
                    UnderBarFrame.BorderSizePixel = 0
                    ...
                    AlrightBtn.BackgroundColor3 = Color3.fromRGB(0, 0, 30)
                ...
                local ServerHold = {}
                ServerHold.Server = function(self, text, img)
                    local fc = false
                    ...
                    ServerFrame1.Visible = false
                    ServerFrame1.Parent = ServerFrame
                    ServerFrame1.BackgroundColor3 = Color3.fromRGB(17, 17, 17)
                    ServerFrame1.BorderSizePixel = 0
                    ServerFrame.BackgroundTransparency = 1
                    ServerFrame1.Position = UDim2.new(0, 0, 0.972290039, 0)
                    ServerFrame1.Size = UDim2.new(0, 12, 0, 10)
                    ServerFrame2.Name = "ServerFrame2"
                    ServerFrame2.Visible = false
                    ServerFrame2.Parent = ServerFrame
                    ServerFrame2.BackgroundColor3 = Color3.fromRGB(17, 17, 17)
                    ...
                    ServerTitleFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                    ...
                    ServerContentFrame.BackgroundColor3 = Color3.fromRGB(17, 17, 17)
                    ...
                    ChannelTitleFrame.BackgroundColor3 = Color3.fromRGB(17, 17, 17) 
                    ChannelTitleFrame.BackgroundTransparency = 1
                    ...
                    ChannelContentFrame.BackgroundColor3 = Color3.fromRGB(17, 17, 17)
                    ...
                    GlowChannel.BackgroundTransparency = 1
                    ...
                    local ChannelHold = {}
                    ChannelHold.Channel = function(self, text)
                        ...
                        ChannelBtn.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                        ...
                        ChannelContent.Button = function(self, text, callback)
                        ...
                        ChannelContent.Toggle = function(self, text, default, callback)
                            local toggled = false
                            local Toggle = Instance.new("TextButton")
                            local ToggleTitle = Instance.new("TextLabel")
                            local ToggleFrame = Instance.new("Frame")
                            local ToggleFrameCorner = Instance.new("UICorner")
                            local ToggleFrameCircle = Instance.new("ImageLabel")
                            ...
                            ToggleFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 30) 
                            ...
                            ToggleFrameCircle.BackgroundColor3 = Color3.fromRGB(0, 0, 30)
                            ToggleFrameCircle.BackgroundTransparency = 1
                        ...
                        ChannelContent.Slider = function(self, text, min, max, start, callback)
                            local SliderFunc = {}
                            ...
                            local Zip = Instance.new("ImageLabel")
                            ...
                            SliderFunc.Change = function(self, tochange)
                                CurrentValueFrame.Size = UDim2.new((tochange or 0) / max, 0, 0, 8)
                                Zip.Position = UDim2.new((tochange or 0) / max, -6, -0.644999981, 0)
                                ValueLabel.Text =
                                    tostring((tochange and math.floor(((tochange / max) * (max - min)) + min)) or 0)
                                pcall(callback, tochange)
                            end
                            ChannelHolder.CanvasSize = UDim2.new(0, 0, 0, ChannelHolderLayout.AbsoluteContentSize.Y)
                            return SliderFunc
                        end
                        ChannelContent.Seperator = function(self)
                        ...
                        ChannelContent.Dropdown = function(self, text, list, callback)
                            local DropFunc = {}
                            local itemcount = 0
                            local framesize = 0
                            local DropTog = false
                            ...
                            DropdownFrameOutline.BackgroundColor3 = Color3.fromRGB(37, 40, 255)
                            DropdownFrameOutline.BackgroundTransparency = 1
                            ...
                            CurrentSelectedText.TextSize = 30
                            ...
                            DropdownFrameMainOutline.BackgroundColor3 = Color3.fromRGB(37, 40, 255)
                            DropdownFrameMainOutline.BackgroundTransparency = 1
                            ...
                            DropItemHolderLabel.BackgroundTransparency = 1
                            ...
                            DropItemHolderLabel.TextSize = 14
                            ...
                            DropFunc.Add = function(self, textadd)
                                itemcount = itemcount + 1
                                if (itemcount == 1) then
                                    framesize = 29
                                elseif (itemcount == 2) then
                        ...
                        ChannelContent.Colorpicker = function(self, text, preset, callback)
                            ...
                            ColorpickerFrameOutline.BackgroundColor3 = Color3.fromRGB(37, 40, 255)
                            ColorpickerFrameOutline.BackgroundTransparency = 1
                        ...
                        ChannelContent.Textbox = function(self, text, placetext, disapper, callback)
                        ...
                        ChannelContent.Label = function(self, text)
                        ...
                        ChannelContent.Bind = function(self, text, presetbind, callback)
                            ...
                            KeybindText.Size = UDim2.new(0, 70, 0, 30)
                            KeybindText.Font = Enum.Font.Gotham
                            KeybindText.Text = presetbind.Name
                            KeybindText.TextColor3 = Color3.fromRGB(255, 255, 255)
                            KeybindText.TextSize = 30
                            ...
                            ChannelHolder.CanvasSize = UDim2.new(255, 192, 203, ChannelHolderLayout.AbsoluteContentSize.Y)
                        end
    ...
    elseif players.LocalPlayer then
        game.Players.LocalPlayer:Kick("You Not In Whitelist")
    end
